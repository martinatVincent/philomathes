...
<?php if($w_user['role']=='Admin'):?>
  <div class="container center">
    <h3 id="marge-titre" class"container grey lighten-4 z-depth-1">Êtes Vous sûr de vouloir supprimer un profil ?</h3>
    <div class="row ">
      <form method="POST" class="col s12 m12 l6 offset-l3">
          ...
          <label for="email2">Tapez à nouveau l'e-mail pour confirmer</label>
