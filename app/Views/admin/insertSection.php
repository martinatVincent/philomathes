  ...
  <div class="row">
    <form method="POST" class="col s12 m12 l6 offset-l3" >
      <div class="input-field ">
        <select>
          <option value="" disabled selected>Choisir le type métier</option>
          <option value="formation">Formation professionnel</option>
          <option value="atelier">Atelier loisir</option>
        </select>
      </div>
        <div class="input-field">
