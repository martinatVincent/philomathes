...
<div class="container center">
  ...
  <div class="row">
    ...
    <ul class="collapsible popout" data-collapsible="accordion">
      <li>
        <div class="collapsible-header"><i class="material-icons">filter_drama</i>formations</div>
        <div class="collapsible-body"><form method="POST" class="col s12 m12 l6 offset-l3" >
        ...
        <li>
          <div class="collapsible-header"><i class="material-icons">place</i>atelier</div>
          <div class="collapsible-body"><form method="POST" class="col s12 m12 l6 offset-l3" >
            <div class="input-field ">
