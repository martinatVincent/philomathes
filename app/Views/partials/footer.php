	...
	<div class="teal row">
		<div class="container">
			<div class="col l6 m6 s6 divfooter">
				<h5 class="ad-philo">Adresse : 66 Rue Abbé de l'Épée,<br> 33000 Bordeaux</h5>
				<a href="https://www.facebook.com/Philomathique-de-Bordeaux-815911835182414/?rf=122992434421050"> <i class="fa fa-facebook-square fa-3x"></i></a>
				<a href="https://twitter.com/hashtag/philomatique"> <i class="fa fa-twitter-square fa-3x"></i></a>
				<a href="http://websta.me/tag/philomatique"><i class="fa fa-instagram fa-3x"></i></a>
			</div>
			<div class="right-align col l6 m6 s6 divfooter">
				<ul>
					...
					<li><!-- Modal Trigger -->
						<a class="modal-trigger waves-effect waves-light btn" href="#modal1">Conditions générales d'utilisation</a>
								...
								<div class="container">
									...
									<section id="Objet-des-CGU" class="center-align container card teal lighten-5">
										...
										<p class="card-panel teal bn" style="color:white;">Le présent document a pour objet de définir les modalités et conditions dans lesquelles d’une part, Philomatique , ci-après dénommé l’EDITEUR, met à la disposition de ses utilisateurs le site, et les services disponibles sur le site et d’autre part, la manière par laquelle l’utilisateur accède au site et utilise ses services.Toute connexion au site est subordonnée au respect des présentes conditions.<br>
											...
											Pour l’utilisateur, le simple accès au site de l’EDITEUR à l’adresse URL suivante Philomatique implique l’acceptation de l’ensemble des conditions décrites ci-après.</p></br>
											...
											<section id="cont-des-CGU" class=" container center-align card- teal grey lighten-5">
												...
												<p>Le site Philomatque peut contenir des liens hypertextes vers d’autres sites présents sur le réseau Internet. Les liens vers ces autres ressources vous font quitter le site Philomatique,<br><br>
												...
												<section id="cont-des-CGU" class=" container center-align card- teal grey lighten-5">
													...
													<section id="cont-des-CGU" class=" container center-align card- teal grey lighten-5">
														...
														<p>L’utilisateur déclare accepter les caractéristiques et les limites d’Internet, et notamment reconnaît que :
															...
															L’utilisateur reconnaît que les données circulant sur Internet ne sont pas protégées notamment contre les détournements éventuels. La présence du logo Philomatique institue une présomption simple de validité. La communication de toute information jugée par l’utilisateur de nature sensible ou confidentielle se fait à ses risques et périls.
